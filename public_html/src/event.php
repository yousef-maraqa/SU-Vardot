...
<body>
 ...
 <?php include('./includes/navbar.php'); ?>
  ...
  <section id="img-title" class="m-0">
    <picture>
      <img src="./assets/group-8@2x.png" alt="SU Event" loading="lazy" />
    </picture>
    ...
    <div class="event-title">
      <h1 class="event-text">Postgraduate Drop-in Evening</h1>
    </div>
  </section>
  ...
  <div class="event-content">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <img src="./assets/alumnievents.jpg" alt="event" loading="lazy" />
        </div>
        <div class="col-md-4">
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-12 d-flex align-items-center p-0 mb-2">
                  ...
                  <span>2:00 P.M - 4:00 P.M.</span>
                </div>
              </div>
              <div class="row">
                <div class="col-12 d-flex align-items-center p-0 mb-2">
                  <i class="far fa-building mr-2"></i>
                  <span>Ajloun Campus</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <p class="mt-5">
        ...
        nemo nisi facilis tempore ipsa, laborum quo, nihil id quis provident
        rem. Voluptatum, totam nesciunt eaque fugiat eveniet iusto delectus
        veritatis aliquam accusantium velit possimus voluptate repudiandae
        libero molestiae cupiditate fuga vel, repellendus vitae vero tempora
        ipsam, culpa impedit amet aperiam. Porro aliquam architecto suscipit
        commodi hic. Illo iusto enim quis autem, accusantium nemo aliquam at,
        nam beatae voluptates repellat inventore fuga nostrum. Dolores qui
        obcaecati debitis quibusdam animi porro molestias architecto veniam
        rerum aspernatur mollitia ducimus, atque earum aut voluptates vel
        tempora fuga quam modi ipsa, est eveniet? Debitis officia excepturi
        vel vero aut rem ullam, ratione quam labore aliquid. Assumenda modi
        mollitia consectetur? Neque natus quam ratione dignissimos sapiente
        beatae commodi magni asperiores, non autem eius nobis officia atque
        necessitatibus vel saepe laboriosam nostrum itaque voluptatem aliquam
        perspiciatis. Provident voluptatum in eveniet rerum, voluptate ducimus
        repellat eligendi sed tempore officiis impedit quam earum veritatis
        repudiandae consequatur reiciendis eum sequi quod! Error, nisi
        distinctio soluta sapiente ipsam tempora aut quaerat? Officia sequi
        eaque voluptate explicabo neque recusandae earum, deserunt culpa
        soluta consectetur aliquid ab, quam cumque dolorem cupiditate
        asperiores iste, magnam architecto odio libero et placeat atque
        incidunt inventore! Odit.
      </p>
      <p class="mt-5">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores
        nemo nisi facilis tempore ipsa, laborum quo, nihil id quis provident
  ...
  <section class="moreEvents">
    <div class="container" id="events">
      <div class="title-wrapper text-uppercase text-center">
        <span class="title-m">more events</span>
      </div>
      <div class="row">
        <div class="col-lg-6 col-xl-4">
          <div class="card" id="card-left">
            ...
            <div class="card-body pb-0 d-flex flex-column align-items-end justify-content-between">
              ...
              <div class="read-more">
                <a class="text-uppercase stretched-link" href="#">read more</a>
